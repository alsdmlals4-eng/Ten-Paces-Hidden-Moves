...
새 세션·post-merge에서는 저장된 SHA나 과거 PR 번호를 current로 재사용하지 않는다. `ACTIVE_CONTEXT.md`, GitHub main/open PR, Sheet `00·02·04·99`, current operating/entry gate를 fresh-read해 현재 상태를 판정한다.
