...
제품 코드0f4d446a의 Windows 실행본은 `build/windows/TenPaces-Reference-Preparation-20260925-Windows.zip`이며 자동 제품 검사50/50·실패0과 압축 무결성을 확인했다. HTML 전투 준비는 실제1086×1448 캡처, 합 영상은735프레임/30.625초의 실제3/3/4 녹화다. 전달·집중 회귀·기존 실패와 최종 원격 검사 경계는 `docs/operations/2026-09-09_CLASH_DIRECTION_EXECUTION_REPORT.md`의 최신 전달 절과 PR367 live metadata를 따른다. 다음 사용자 검수는 참조 구도와 교체 캐릭터의 최종 모습이다.
