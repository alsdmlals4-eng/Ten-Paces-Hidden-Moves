...
def build(captures: Path, output: Path):
    ...
    b.photo(captures/'reference-screens/preparation-hud-edited-v2.png',30,130,520,350)
    ...
    b.p('AI 편집 참고안 · 상단 상태창 여백 수정 · 실행 촬영과 최종 자산 승인 아님',30,105,750,10)
    ...
    b.table(['표시','뜻','이번 문서에서의 예'],[
        ...
        ['실행 촬영','해당 상태를 실제 화면으로 확인','카드 공개, 합 동작'],
    ...
    b.photo(ROOT/'assets/backgrounds/ink_wuxia/journey.png',30,180,450,290)
    ...
    b.photo(ROOT/'assets/backgrounds/ink_wuxia/rest.png',30,120,540,350)
    ...
    b.page('전투 준비 · 상태창 여백 수정 참고안','상단 이름과 상태 표시의 장식 간섭을 줄이는 편집안. 실제 수치는 현재 게임 데이터를 따른다.','AI 편집 참고안 / 실행 촬영 아님 / 사용자 최종 검수 전')
    b.photo(captures/'reference-screens/preparation-hud-edited-v2.png',30,78,W-60,405)
    b.p('수정 참고안의 게임 적용·실제 실행·최종 자산 승인은 별도이며, 하단 수치와 문구를 현재 게임 근거로 쓰지 않는다.',30,65,W-60,9)
