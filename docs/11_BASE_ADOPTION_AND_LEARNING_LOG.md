...
현재 PR #7은 Prototype다. STEP 0~10과 TARGETING 10.5는 기존 Windows 흐름이 확인됐고, 플레이어 4번·상대 7번 시작과 RESPONSE·RESOURCE PREVIEW 10.6은 최신 사용자 런타임 확인 대기다.
...
- 이번 변경의 최신 Actions.
- 사용자 Windows 4번·7번 렌더·판정.
- RESPONSE 10.6 최신 Godot 런타임.
- RESOURCE PREVIEW 10.6 최신 Godot 런타임.
