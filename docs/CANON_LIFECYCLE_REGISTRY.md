...
| 시작 공개 거리 런타임 매핑 | `docs/decisions/2026-08-28_OPENING_DISTANCE_RUNTIME_MAPPING_DECISION.md`, `TEN-DEC-20260828-OPENING-DISTANCE-RUNTIME-MAPPING-01` |
| 첫 5전 패배·재도전 여정 | `docs/decisions/2026-08-28_FIRST_FIVE_DEFEAT_RETRY_SCOPE_DECISION.md`, `TEN-DEC-20260828-FIRST_FIVE-DEFEAT-RETRY-SCOPE-01` |
