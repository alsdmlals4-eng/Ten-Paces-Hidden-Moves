...
- 권위 Decision: `TEN-DEC-20260804-POSTMERGE-CANON-ADVERSARIAL-AUDIT-01`
- 기준 main: `0ba841ff2e62b2f716466356dd9e7ffcf587d150`
- 목적: 구형 파일·PR·계약이 현행 정본으로 오인되는 것을 차단한다.
...
- 실행하지 않은 Godot·Windows·접근성·사람 검증을 PASS로 표시
