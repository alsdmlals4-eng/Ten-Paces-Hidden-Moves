...
2026-09-20 PR342 작업 branch: P01 보유 전체 사용, P02 자유 수련, P03 새 여정v4 시작 배분/영구 성장/기술 능력 요구치를 구현했다. `docs/decisions/2026-09-20_PERMANENT_PLAYER_GROWTH_V4.md`와 기존 수련 실행 기록9월20일 절을 따른다. 아래9월9일 문구는 당시 foundation 계보이며 현재 미구현 목록이 아니다. main 병합·Human·밸런스·출시는 별도 상태다.
