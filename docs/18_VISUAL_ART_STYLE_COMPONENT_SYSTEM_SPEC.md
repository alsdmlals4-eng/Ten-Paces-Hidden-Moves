...
2026-09-24 사용자가 선택한 차기 제작 방향은 [수묵 무협 만화 화풍과 이어지는 전투 연출](decisions/2026-09-24_INK_WUXIA_STYLE_AND_FLOW.md)이다. **8번의 인물·선, 3번의 명암 대비, 9번의 안개·여백**을 사용한다. 아래2026-08-20 반실사 키는 기존 적용 기준의 이력이며 새 제작 방향보다 우선하지 않는다. 현재 자산의 실제 연결과 새 화풍 적용 완료는 구분한다.

연출 제작은 [상단 합과 결과별 반응](decisions/2026-09-09_CLASH_STAGING_AND_OUTCOME_DIRECTION.md)의 조사·핵심 자세·승패 반응·효과 off/on 기준을 따른다. 이는 기존 자산 일괄 교체나 게임 판정 변경 승인이 아니다.
