...
720p는 headless만 검증했다. PR 325 exact head 34/34 SUCCESS와 병합 후 main 검증을 완료했다.
병합 SHA와 증거·잔여 Gate는 `docs/operations/2026-09-08_PR325_PROTECTED_CHANGE_APPROVAL_RECORD.md`가 소유한다.
