...
- An explicit planning observation is a durable information action: merge its observation fields and actual enemy lock into the stable planning baseline without retaining unsent plan reservations. Preserve existing enemy-lock timing; do not move the AI decision earlier just to save.
