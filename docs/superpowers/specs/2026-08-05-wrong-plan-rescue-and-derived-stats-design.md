...
- `MISSING_DEFENSE_RESPONSE`: 공개된 위협에 방어·회피·중단 대응을 두지 않음.
...
6. 사거리 밖 공격은 외공이 높아도 실패.
7. 방어 행동이 없으면 근골 방어 보정 0.
8. 구형 통합 공격력과 기술 계수 중복 적용 거부.
9. 동일 계획·난수 반사실 재계산의 결정성.
10. 결과 역전과 중대 구제의 상호 배타 집계.
11. 올바른 계획 증폭은 구제로 집계하지 않음.
12. 심안의 미공개 계획 접근 거부.
