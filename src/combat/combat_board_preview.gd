...
var review_summary_builder: CombatReviewSummaryBuilder
...
func _build_structure() -> void:
	...
	combat_review_panel.detail_requested.connect(_on_review_detail_requested)
	combat_review_panel.continue_requested.connect(_on_review_continue_requested)
	add_child(combat_review_panel)
...
func _layout_board() -> void:
	...
	if is_instance_valid(combat_review_panel):
		...
		combat_review_panel.size = review_size
		combat_review_panel.position = Vector2((size.x - review_size.x) * 0.5, clampf((size.y - review_size.y) * 0.45, 70.0, 180.0))
...
func _configure_keyboard_focus_order() -> void:
	...
	if is_instance_valid(combat_review_panel) and combat_review_panel.visible:
