...
const BACKGROUND_PATH := "res://assets/combat/ink_wuxia/background.png"
const BANNER_PATH := "res://assets/foregrounds/frontal_courtyard_banner_overlay_01_v1.png"
const PLAYER_BATTLER_PATH := "res://assets/combat/ink_wuxia/player-0.png"
const DOGYEOM_BATTLER_PATH := "res://assets/combat/ink_wuxia/slot1_dogyeom/enemy-0.png"
const GENERIC_ENEMY_BATTLER_PATH := "res://assets/combat/ink_wuxia/masked_baekmujin/enemy-0.png"
