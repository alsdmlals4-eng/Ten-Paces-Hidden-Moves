...
class IntegratedWorkContractV48R54Tests(unittest.TestCase):
    ...
    def test_current_visual_production_is_exactly_one(self) -> None:
        ...
        self.assertEqual("USER_APPROVED_2026_08_26", master["status"])
        self.assertEqual("PASS", master["notion_delivery"])
        ...
        self.assertEqual("GPT_WORK_RESUME_REQUIRED", planning["next_image_generation"])
