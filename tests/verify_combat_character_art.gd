...
func _run() -> void:
    ...
    _require_role_art(board.player_character, "player", "res://assets/combat/ink_wuxia/player-0.png")
    _require_role_art(board.enemy_character, "enemy", "res://assets/combat/ink_wuxia/masked_baekmujin/enemy-0.png")
