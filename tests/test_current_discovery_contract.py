...
class CurrentDiscoveryContractTests(unittest.TestCase):
    ...
    def test_active_context_separates_live_state_from_observed_snapshots(self) -> None:
        ...
        self.assertIn(
            "user_directed_planning_status: FRONTAL_COURTYARD_DUEL_PRESENTATION_USER_FINAL_LOCKED_CANON_REGISTERED_IMPLEMENTED_MACHINE_RUNTIME_VERIFIED_20260831_PLUS_SHARED_MARTIAL_AND_ULTIMATE_CARD_ATLAS_GENERATED_CANDIDATE_AWAITING_USER_FINAL_LOCK_HUMAN_PLAYER_COMPARISON_DEFERRED",
            current_section,
        )
        self.assertIn(
        ...
        self.assertIn("planning_visual_next: MARTIAL_AND_ULTIMATE_CARD_ILLUSTRATION_ATLAS_01_GENERATED_CANDIDATE_AWAITING_USER_FINAL_LOCK", current_section)
        self.assertIn(
            "planning_visual_generation: SCOPED_SINGLE_RESULT_GENERATED_CANDIDATE_SEPARATE_FINAL_USER_LOCK_REQUIRED",
            current_section,
        )
        self.assertIn(
            "planning_visual_review: FRONTAL_COURTYARD_DUEL_BACKGROUND_01_USER_FINAL_LOCKED_IMPLEMENTED_MACHINE_RUNTIME_VERIFIED_PLUS_MARTIAL_ULTIMATE_CARD_ATLAS_CANDIDATE",
            current_section,
        )
        self.assertIn(
    ...
    def test_current_user_planning_status_records_deferred_human_gate_and_runtime_gap(self) -> None:
        ...
        self.assertEqual(
            "FRONTAL_COURTYARD_DUEL_PRESENTATION_USER_FINAL_LOCKED_CANON_REGISTERED_IMPLEMENTED_MACHINE_RUNTIME_VERIFIED_20260831_PLUS_SHARED_MARTIAL_AND_ULTIMATE_CARD_ATLAS_GENERATED_CANDIDATE_AWAITING_USER_FINAL_LOCK_HUMAN_PLAYER_COMPARISON_DEFERRED",
        ...
        self.assertEqual(
            "USER_FINAL_LOCKED_CANON_REGISTERED_IMPLEMENTED_GODOT_4_7_1_VISIBLE_RUNTIME_VERIFIED_HUMAN_READABILITY_NOT_RUN",
            status["evidence_ceiling"]["frontal_courtyard_duel_presentation"],
        )
        self.assertEqual(
            "GENERATED_CANDIDATE_HASH_READBACK_ONLY_AWAITING_USER_FINAL_LOCK_RUNTIME_NOT_IMPLEMENTED",
            status["evidence_ceiling"]["martial_ultimate_card_illustration_atlas"],
        )
        self.assertEqual(
