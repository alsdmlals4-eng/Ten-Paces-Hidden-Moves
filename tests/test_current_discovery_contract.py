...
class CurrentDiscoveryContractTests(unittest.TestCase):
    ...
    def test_active_context_separates_live_state_from_observed_snapshots(self) -> None:
        ...
        current_section = text.split("## 현재 기준", 1)[1].split("## 현재 권위와 보호 결정", 1)[0]
        ...
        self.assertIn("next_package: TEN_IMG_001_GENERATE_EXPLORATION", current_section)
        self.assertIn("next_planning_decision: TEN_IMG_001_EXPLORATION_REVIEW", current_section)
