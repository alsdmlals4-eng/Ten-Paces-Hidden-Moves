...
class CurrentDiscoveryContractTests(unittest.TestCase):
    ...
    def test_current_user_planning_status_records_deferred_human_gate_and_runtime_gap(self) -> None:
        ...
        self.assertEqual(
            "INK_PAPER_DIAGONAL_DUEL_PRESENTATION_IMPLEMENTED_MERGED_MAIN_PR277_PROTECTED_APPROVAL_ARCHIVED_PR278_MACHINE_RUNTIME_VERIFIED_HUMAN_PLAYTEST_DEFERRED_PLUS_BALANCE_INSTRUMENTATION_IMPLEMENTED_MERGED_MAIN_PR280_REMOTE_CI_PASS_PROTECTED_APPROVAL_ARCHIVED_PR281_POSTMERGE_READBACK_PLUS_BALANCE_MEASUREMENT_POLICY_COVERAGE_EXTENSION_IMPLEMENTED_MERGED_MAIN_PR289_REMOTE_CI_PASS_PROTECTED_APPROVAL_ARCHIVED_PR290_POSTMERGE_READBACK_PLUS_BALANCE_MEASUREMENT_REPRESENTATIVE_POLICY_COVERAGE_IMPLEMENTED_MERGED_MAIN_PR292_REMOTE_CI_PASS_PROTECTED_APPROVAL_ARCHIVED_PR293_POSTMERGE_READBACK_PLUS_REPRESENTATIVE_POLICY_COVERAGE_RESULT_REVIEW_LOCAL_COMPLETE_PR_PENDING_NO_NUMERICAL_MUTATION_RECOMMENDED",
        ...
        self.assertEqual(
            "SCHEMA_3_REPRESENTATIVE_POLICY_COVERAGE_IMPLEMENTED_MERGED_MAIN_PR292_REMOTE_CI_PASS_PROTECTED_APPROVAL_ARCHIVED_PR293_POSTMERGE_READBACK_HEADLESS_FULL_MATRIX_6750_ROWS_TWO_BYTE_IDENTICAL_REPORTS_RESULT_REVIEW_LOCAL_COMPLETE_PR_PENDING_NO_NUMERICAL_MUTATION_RECOMMENDED_WINDOWS_HUMAN_ANDROID_ACCESSIBILITY_RELEASE_NOT_RUN",
        ...
        self.assertEqual(
            "IMPLEMENTED_MERGED_MAIN_PR292_REMOTE_CI_PASS_PROTECTED_APPROVAL_ARCHIVED_PR293_POSTMERGE_READBACK_6750_SCENARIOS_TWO_BYTE_IDENTICAL_REPORTS_SCHEMA_3_RESULT_REVIEW_LOCAL_COMPLETE_PR_PENDING_NO_NUMERICAL_MUTATION_RECOMMENDED",
