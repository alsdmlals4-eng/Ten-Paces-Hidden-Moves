...
class CurrentDiscoveryContractTests(unittest.TestCase):
    ...
    def test_current_user_planning_status_records_deferred_human_gate_and_runtime_gap(self) -> None:
        ...
        self.assertEqual(
            "USER_FINAL_LOCKED_CANON_REGISTERED_IMPLEMENTED_MACHINE_VERIFIED_WINDOWS_REFERENCE_LAYOUT_HOVER_DETAIL_PLAN_LOCK_AND_CURRENT_ACTION_REVEAL_RUNTIME_CAPTURED_TEN_RVC_20260903_001_003_004_005_006_HUMAN_ANDROID_ACCESSIBILITY_RELEASE_NOT_RUN",
